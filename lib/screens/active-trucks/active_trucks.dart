          ...
          Column(
            children: [
              _buildInfoItemWithLabel(Icons.location_on, 'Location',
                  truck.location, iconColorDahsbaord2),
              const SizedBox(height: 8),
              _buildInfoItemWithLabel(
                  Icons.route, 'Route', truck.route, iconColorDahsbaord2),
              const SizedBox(height: 8),
              _buildInfoItemWithLabel(
                  Icons.person, 'Driver', truck.driver, iconColorDahsbaord2),
              const SizedBox(height: 8),
              _buildInfoItemWithLabel(Icons.local_gas_station, 'Fuel Level',
                  truck.fuel, iconColorDahsbaord2),
            ],
          ),
          const SizedBox(height: 12),
